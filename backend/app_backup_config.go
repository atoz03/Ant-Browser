...
func (a *App) backupClearBusinessTables() error {
	...
	tables := []string{"launch_codes", "browser_profiles", "browser_proxies", "browser_cores", "browser_bookmarks", "browser_groups", "browser_extensions", "browser_extension_scope_settings", "browser_extension_scope_profiles", "browser_profile_extension_settings", "browser_profile_extensions"}
